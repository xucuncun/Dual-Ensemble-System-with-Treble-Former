...
class FCBFormer(nn.Module):
    def __init__(self, n_channels, n_classes, img_bian=352, path='Models/pvt_v2_b2.pth'):
        ...
        self.TB = TB(self.path)

        self.FCB = FCB(in_resolution=img_bian)
        self.PH = nn.Sequential(
            RB(64 + 32, 64), RB(64, 64), nn.Conv2d(64, self.n_classes, kernel_size=1)
        )
