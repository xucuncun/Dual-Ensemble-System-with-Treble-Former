...
class UNet(BaseModel):
    def __init__(self, n_channels, n_classes, freeze_bn=False, **_):
        super(UNet, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes

        self.start_conv = x2conv(n_channels, 64)
...
class UNetResnet(BaseModel):
    def __init__(self, n_channels, n_classes, backbone='resnet50', pretrained=True, freeze_bn=False, freeze_backbone=False, **_):
        ...
        self.conv7 = nn.Conv2d(32, n_classes, kernel_size=1, bias=False)
