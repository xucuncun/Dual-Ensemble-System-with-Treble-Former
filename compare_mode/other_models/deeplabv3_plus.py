...
class DeepLab(BaseModel):
    def __init__(self, n_channels, n_classes, backbone='xception', pretrained=True,
        ...
        if 'resnet' in backbone:
            self.backbone = ResNet(in_channels=n_channels, output_stride=output_stride, pretrained=pretrained)
        ...
        self.decoder = Decoder(low_level_channels, n_classes)
