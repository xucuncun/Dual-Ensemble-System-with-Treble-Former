...
class UperNet(BaseModel):
    ...
    def __init__(self, n_channels, n_classes, backbone='resnet101', pretrained=True, use_aux=True, fpn_out=256, freeze_bn=False, freeze_backbone=False, **_):
        ...
        self.backbone = ResNet(n_channels, pretrained=pretrained)
        self.PPN = PSPModule(feature_channels[-1])
        self.FPN = FPN_fuse(feature_channels, fpn_out=fpn_out)
        self.head = nn.Conv2d(fpn_out, n_classes, kernel_size=3, padding=1)
