...
class FCN8(BaseModel):
    def __init__(self, n_channels, n_classes, pretrained=True, freeze_bn=False, freeze_backbone=False, **_):
        ...
        # Adjust the depth of pool3 and pool4 to n_classes
        self.adj_pool3 = nn.Conv2d(256, n_classes, kernel_size=1)
        self.adj_pool4 = nn.Conv2d(512, n_classes, kernel_size=1)
        ...
        output = nn.Conv2d(4096, n_classes, kernel_size=1)
        ...
        self.up_output = nn.ConvTranspose2d(n_classes, n_classes,
                                            kernel_size=4, stride=2, bias=False)
        self.up_pool4_out = nn.ConvTranspose2d(n_classes, n_classes,
                                            kernel_size=4, stride=2, bias=False)
        self.up_final = nn.ConvTranspose2d(n_classes, n_classes,
